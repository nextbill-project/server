...
2. Konsultieren Sie das [FAQ](https://github.com/nextbill-project/server/faq). Viele Fragen können dort schon beantwortet werden, außerdem werden stetig Fragen & Antworten ergänzt.
