...
public class BillingListProcessItemComparator implements Comparator<BillingListProcessItem> {

    public BillingListProcessItemComparator() {
    }

    @Override
    public int compare(BillingListProcessItem o1, BillingListProcessItem o2) {
